tests: 
	...
	for num_threads in 2 4 8 12 ; do \
		for num_iterations in 100 1000 10000 100000 ; do \
			./lab2_add  --iterations=$$num_iterations --threads=$$num_threads >> lab2_add.csv ; \
		done \
	done 
	...
	for num_threads in 2 4 8 12 ; do \
		for num_iterations in 10 20 40 80 100 1000 10000 100000 ; do \
			./lab2_add --iterations=$$num_iterations --threads=$$num_threads --yield >> lab2_add.csv ; \
		done \
	done

	# Perform tests for each of the synchronization methods with the yield option
	for num_threads in 2 4 8 12 ; do \
		./lab2_add --iterations=10000 --threads=$$num_threads --yield --sync=m >> lab2_add.csv ; \
		./lab2_add --iterations=1000 --threads=$$num_threads --yield --sync=c >> lab2_add.csv ; \
		./lab2_add --iterations=10000 --threads=$$num_threads --yield --sync=s >> lab2_add.csv ; \
	done